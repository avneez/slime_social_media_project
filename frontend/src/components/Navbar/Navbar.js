    ...
    return (
        <AppBar className={classes.appBar} position="static" color="inherit">
            <div className={classes.brandContainer}>
                <Typography component={Link} to="/" className={classes.heading} variant="h2" align="center"><b>SLIME</b></Typography>
                <img className={classes.image} src={slime} alt="icon" height="60" />
            </div>
